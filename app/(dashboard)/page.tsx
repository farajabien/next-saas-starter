					...
					<div className='lg:grid lg:grid-cols-12 lg:gap-8'>
						<div className='sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left'>
							...
							<p className='mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl'>
								Launch your SaaS product with local payment integrations. Built
								specifically for businesses targeting the African market, with
								MPESA and local currency support.
							</p>
					...
					<div className='lg:grid lg:grid-cols-3 lg:gap-8'>
						...
						<div className='mt-10 lg:mt-0'>
							...
							<div className='mt-5'>
								...
								<p className='mt-2 text-base text-gray-500 relative'>
					...
					<div className='lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center'>
						<div>
							...
							<p className='mt-3 max-w-3xl text-lg text-gray-500'>
								...
								and running quickly, with special focus on African payment
								methods and local currency support. Perfect for startups
				...
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
					<div className='flex items-center justify-center gap-4 text-white'>
						...
						<p className='text-sm font-medium'>
							Paystack + MPESA Integration Coming Next Week - Get Early Access!
						</p>
						<Button
							variant='outline'
